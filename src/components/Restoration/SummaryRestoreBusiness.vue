<template>
  <div id="summary-restore-business">
    <section :class="{ 'invalid-section': !isRestoreBusinessNameValid }">
      <div v-if="!isRestoreBusinessNameValid" class="restoreBusinessStepErrorMessage">
        <span>
      ...
      <article class="section-container">
        ...
        <v-row no-gutters>
          ...
          <!-- Name Translation -->
          <v-row no-gutters v-if="getNameTranslations && getNameTranslations.length > 0" class="mt-6">
            <v-col cols="12" sm="3" class="pr-4">
        ...
        <v-row no-gutters class="mt-6">
          ...
          <v-col cols="12" sm="9">
            <template v-if="getRestoration.approvalType === ApprovalTypes.VIA_COURT_ORDER">
              ...
              <p id="court-order-number">Court Order Number: {{ getRestoration.courtOrder.fileNumber }}</p>
            </template>
